            ...
            <Box
                ...
                <Box sx={{ display: 'flex', justifyContent: 'space-between', width: '100%', alignItems: 'flex-end', mt: 'auto', px: 2 }}>
                    ...
                    <Box textAlign="right">
                        ...
                        <Typography variant="caption" sx={{ fontSize: '0.5rem', color: 'text.secondary' }}>
                            Verify at: <Link href={`${window.location.origin}/verify-certificate/${certificateId}`} underline="hover" color="inherit" target="_blank" rel="noopener noreferrer">{window.location.host}/verify-certificate/{certificateId}</Link>
                        </Typography>
                    </Box>
                </Box>
            </Box>
